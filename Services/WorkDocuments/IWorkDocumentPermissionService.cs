...
public interface IWorkDocumentPermissionService
{
    ...
    Task<bool> CanUpdateFileAsync(FileDoc file, string userId, CancellationToken ct);
    Task EnsureCanUpdateFileAsync(FileDoc file, string userId, CancellationToken ct);
